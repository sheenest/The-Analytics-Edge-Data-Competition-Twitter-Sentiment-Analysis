...
# clean_punc( "fuckkk i need sleepppppppp lol" )
...
```{r}
# Calculate the Final Accuracy of both the Logistic Models Combined together 
correct <- 0

for (i in 1:nrow(test_data)) {
  if (test_data$sentiment[i] == test_data$Predicted_Sentiment[i]) {
    correct <- correct + 1
  }
}
